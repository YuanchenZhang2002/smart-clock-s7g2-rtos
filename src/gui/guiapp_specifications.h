...
#define ID_LED_BUTTON 1
#define ID_LED_STATUS 2
#define ID_INC_PROMPT 3
#define ID_TIME_PROMPT 4
...
typedef struct WINDOW_SCREEN2_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
} WINDOW_SCREEN2_CONTROL_BLOCK;

typedef struct WINDOW_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_TEXT_BUTTON window_screen_led_button;
    GX_PROMPT window_screen_led_status;
    GX_PROMPT window_screen_prompt_inc;
    GX_PROMPT window_screen_prompt_time;
...
extern WINDOW_SCREEN2_CONTROL_BLOCK window_screen2;
