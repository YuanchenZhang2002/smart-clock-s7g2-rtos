...
/*  Date (dd.mm.yyyy): 22. 1.2026   Time (hh:mm): 02:22                        */
/*******************************************************************************/
...
WINDOW_SCREEN2_CONTROL_BLOCK window_screen2;
...
GX_WINDOW_PROPERTIES window_screen2_properties =
{
    0                                        /* wallpaper pixelmap id          */
};

GX_CONST GX_STUDIO_WIDGET window_screen2_define =
{
    "window_screen2",
    ...
    sizeof(WINDOW_SCREEN2_CONTROL_BLOCK),    /* control block size             */
    GX_COLOR_ID_WINDOW_FILL,                 /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) WindowScreen2EventHandler, /* event function override */
    {0, 0, 239, 319},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    GX_NULL,                                 /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_screen2_properties      /* extended properties            */
};
GX_WINDOW_PROPERTIES window_screen_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_TEXT_BUTTON_PROPERTIES window_screen_led_button_properties =
{
...
GX_PROMPT_PROPERTIES window_screen_led_status_properties =
{
...
GX_PROMPT_PROPERTIES window_screen_prompt_inc_properties =
{
...
GX_PROMPT_PROPERTIES window_screen_prompt_time_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window_screen_prompt_time_define =
{
    "prompt_time",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_TIME_PROMPT,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    {24, 85, 223, 134},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_SCREEN_CONTROL_BLOCK, window_screen_prompt_time), /* control block */
    (void *) &window_screen_prompt_time_properties /* extended properties      */
};

GX_CONST GX_STUDIO_WIDGET window_screen_prompt_inc_define =
{
    "prompt_inc",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_INC_PROMPT,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {61, 259, 175, 301},                     /* widget size                    */
    &window_screen_prompt_time_define,       /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_SCREEN_CONTROL_BLOCK, window_screen_prompt_inc), /* control block */
    (void *) &window_screen_prompt_inc_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET window_screen_led_status_define =
{
    "led_status",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_LED_STATUS,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {68, 140, 168, 185},                     /* widget size                    */
    &window_screen_prompt_inc_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_SCREEN_CONTROL_BLOCK, window_screen_led_status), /* control block */
    (void *) &window_screen_led_status_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET window_screen_led_button_define =
{
    "led_button",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    ID_LED_BUTTON,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {41, 194, 195, 249},                     /* widget size                    */
    &window_screen_led_status_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_SCREEN_CONTROL_BLOCK, window_screen_led_button), /* control block */
    (void *) &window_screen_led_button_properties /* extended properties       */
};
...
GX_CONST GX_STUDIO_WIDGET window_screen_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) WindowScreenEventHandler, /* event function override */
    {0, 0, 239, 319},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window_screen_led_button_define,        /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_screen_properties       /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY guiapp_widget_table[] =
{
    { &window_screen2_define, (GX_WIDGET *) &window_screen2 },
